...
export type DidFunctionSucceed = boolean;
...
export type VSCodeSettingNames = CfgSetting<"", CfgSettings<VSCodeSettingNamesKeys, undefined>>
export type UeClangdSettingNames = CfgSetting<"unreal-clangd", CfgSettings<UeClangdSettingNamesKeys, undefined>>
export type ClangdSettingNames = CfgSetting<"clangd", CfgSettings<ClangdSettingNamesKeys, undefined>>
export type CCppSettingNames = CfgSetting<"C_Cpp", CfgSettings<CCppSettingNamesKeys, undefined>>
...
export type VSCodeDefaultSettings = CfgSetting<"", VSCodeDefaultSettingValues>
export type UeClangdDefaultSettings = CfgSetting<"unreal-clangd", UeClangdDefaultSettingValues>
export type ClangdDefaultSettings = CfgSetting<"clangd", ClangdDefaultSettingValues>
export type CCppDefaultSettings = CfgSetting<"C_Cpp", CCppDefaultSettingValues>
...
export interface UriBackup {original: Uri, backup: Uri}
